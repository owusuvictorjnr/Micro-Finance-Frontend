...
export const aiInsightsItem: NavigationItem = {
  title: "AI Insights",
  icon: Sparkles,
  roles: ["admin"],
  children: [
...
export const reportsItem: NavigationItem = {
  title: "Reports",
  icon: BarChart3,
...
export const integrationsApiItem: NavigationItem = {
...
export const userManagementItem: NavigationItem = {
...
export const supportHelpItem: NavigationItem = {
  title: "Support & Help",
  icon: HelpCircle,
  roles: ["admin", "employee"],
  children: [
