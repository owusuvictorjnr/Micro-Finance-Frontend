...
export const riskCollectionsItem: NavigationItem = {
...
export const complianceKycItem: NavigationItem = {
...
export const borrowersItem: NavigationItem = {
  title: "Borrowers",
  icon: User,
  roles: ["admin", "employee"],
  children: [
...
export const merchantsPartnersItem: NavigationItem = {
...
export const financeItem: NavigationItem = {
  title: "Finance",
  icon: Wallet,
  roles: ["admin", "employee"],
  children: [
